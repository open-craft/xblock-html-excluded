...
quality:  ## Run quality tests and checks
	make selfcheck
	pylint excluded_html_xblock tests
	pylint --py3k excluded_html_xblock
	pycodestyle excluded_html_xblock tests --config=pylintrc
	pydocstyle excluded_html_xblock tests --config=pylintrc
	isort --check-only --diff --recursive tests excluded_html_xblock
